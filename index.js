...
let barChairsMaterials = [];
loader.load(
  "./models/modern_interior_design.glb",
  //"./models/sofa.glb",
  function (gltf) {
    theModel = gltf.scene;
    ...
    theModel.traverse((object) => {
      if (object.isMesh) {
        ...
        //   map: THREE.ImageUtils.loadTexture("./textures/denim_.jpg"),
        //   shininess: 10,
        // });
        //Specify material for each object
        // switch(object.material.name){
        //   case "Big_minder" || "Koltuk_alt" || "material_31":
        //     sofaMaterials.push(object.material);
        //     break;

        //   case "Light":
        //     lightMaterials.push(object.material);
        //     break;
          
        //   case "kucuk_minder":
        //     pillowMaterials.push(object.material);
        //     break;

        //   case "material_8":
        //     barMaterial.push(object.material);
        //     break;

        //   case "Glass_Cerceve" || "Cam_Duvar_Cerceve":
        //     windowsMaterials.push(object.material);
        //     break;

        //   case "Bar_Koltuk": 
        //     barChairsMaterials.push(object.material);
        //     break;
        // }
      }
    });
...
//rectLight2.position.set( -1.2, -1.2, 1 );
rectLight2.lookAt( -1.2, -1.2, 1 );
...
for (const swatch of swatches) {
  swatch.addEventListener("click", (event) =>
    ...
    selectedSwatch(event, theModel, texturesAndColors, activeOption)
  );
}
